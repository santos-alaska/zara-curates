        ...
        <div className="bg-[#F8F5F1] text-[#2a2a2a] min-h-screen pb-20">
            ...
            <section className="py-24 px-6">
                <div className="max-w-2xl mx-auto flex flex-col items-center gap-16">
                    ...
                    >
                        <h1
                            className={` ${dobagi.className} font-serif text-[32px] md:text-6xl font-light tracking-wide mb-10 md:mb-30 mt-10  md:mt-30 text-center`}

                        >
                            A Deliberate Practice</h1>
            ...
            <section className="py-24 px-6 bg-white my-20">
                <div className="max-w-2xl mx-auto  space-y-12">
                    <motion.h2
                        ...
                        className={` ${dobagi.className} font-serif text-[32px] md:text-6xl font-light tracking-wide mb-10 md:mb-30 text-center`}
                ...
                <div className="max-w-2xl mx-auto flex flex-col items-center gap-16">
                    ...
                    >
                        <h2
                            ...
                            className={` ${dobagi.className} font-serif text-[32px] md:text-6xl font-light tracking-wide mb-10 md:mb-30 mt-10 text-center`}

                        >
                            Why Zara Curates Exists</h2>
