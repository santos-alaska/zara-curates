...
//                 {/* <div className="bg-[#1E1C1B]/90 backdrop-blur-sm rounded-[5rem] shadow-2xl p-3 md:p-4" style={{ backgroundImage: "url(/hero-bg2.png)" }}
//           > */}
//                 <div
...
//                         {/* Top Label / Pill */}
//                         <div className="inline-flex items-center justify-center bg-white/5 border border-white/10 text-[10px] md:text-xs tracking-[0.2em] uppercase py-2 px-6 rounded-full mb-8 text-neutral-400">
//                             <span className="font-serif italic text-base mr-2 text-neutral-300">~</span>
//                             Intentional Growth Studio
//                         </div>

//                         {/* Main Headline */}
//                         <h1 className="font-serif text-4xl md:text-6xl lg:text-7xl leading-[1.1] mb-8 font-light tracking-tight text-[#FAF9F6]">
//                             Curated Growth For Brands <br className="hidden md:block" />
//                             <span className="italic text-neutral-400"> & The People Behind Them</span>
//                         </h1>

//                         {/* Subtext */}
//                         <p className="text-neutral-400 text-base md:text-lg max-w-2xl mx-auto mb-12 leading-relaxed font-light">
...
//                         <button className="group relative bg-[#FAF9F6] text-[#1E1C1B] font-medium py-4 px-12 rounded-sm overflow-hidden transition-all duration-300 hover:shadow-[0_0_20px_rgba(255,255,255,0.3)]">
            ...
            >
                ...
                >
                    ...
                    <div className="relative w-full border border-white/20 rounded-[5rem] text-neutral-200 py-16 px-6 md:py-24 md:px-12 text-center flex flex-col items-center">
                        ...
                        {/* Main Headline */}
                        <motion.h1
                            className="font-serif text-4xl md:text-6xl lg:text-7xl leading-[1.1] mb-8 font-light tracking-tight text-[#FAF9F6]"
