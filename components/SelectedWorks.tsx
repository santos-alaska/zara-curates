...
const SelectedWorks = () => {
  return (
    <section className="flex flex-col w-full mb-[200px] md:mb-14">

      {/* TOP SECTION: Text Content (Dark Background Image) */}
      <div className="w-full relative text-[#E5E5E5] py-25 px-6 md:px-20 flex flex-col justify-center items-center ">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <div className="space-y-6 text-[11px] md:text-xl text-neutral-100 font-light leading-relaxed max-w-2xl mx-auto">
            <p>
