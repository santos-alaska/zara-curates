    ...
    return (
        <section className="bg-white py-25 md:py-32 px-6">
            <div className="container mx-auto w-full max-w-3xl">
                ...
                <h2 className="font-serif text-3xl md:text-5xl mb-20 text-black hidden">
                ...
                <div className="space-y-24">
                    ...
                    <div className="flex items-start gap-6 md:gap-10">
                        {/* Number Icon */}
                        <div className="flex-shrink-0 bg-[#E5E5E5] text-white font-serif text-xl w-10 h-10 flex items-center justify-center rounded-[4px] mt-1">
                            1
                        </div>
                        {/* Content */}
                        <div className="flex flex-col text-left">
                            <h3 className="font-serif text-[24px] md:text-4xl text-[#1E1C1B] mb-4">
                                Discovery & Alignment
                            </h3>
                            ...
                            <p className="text-neutral-800 text-sm mt-12">
